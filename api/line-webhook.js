...
Q：請問免運費是多少？
A：折扣後實際支付滿 NT$899 即免運，宅配和超商取貨都適用。外島地區不在免運範圍內。有其他問題歡迎繼續詢問。

Q：我想要退貨
A：7天鑑賞期內未拆封可辦退貨。登入官網 > 會員中心 > 訂單查詢，申請後系統會提供 7-11 退貨便代號，3天內到IBON操作就完成了。已拆封的貼身衣物因衛生考量無法受理，請見諒。

Q：什麼時候出貨？
A：現貨商品 1~3 個工作天出貨，出貨後超商或宅配約 2~4 天送達。若訂單含預購商品，需等全部備齊才一起寄出。想確認特定商品的狀態，可以告訴我商品名稱。

Q：可以推薦我塑身褲嗎？
A：推薦「萊卡抗菌無縫系列」，機能型萊卡紗，彈性好又服貼，修飾效果明顯。尺寸參考：平時穿 M~XL 選 M 號，XL~3L 選 L 號。想進一步推薦的話，可以告訴我您比較在意修飾腹部還是大腿？
...
const QUICK_REPLIES = {
  '1': '__AI__',
  '2': '萊卡系列 M號適合褲子 M～XL；L號適合 XL～3L。建議參考商品頁尺寸表，或告訴我您平時穿的尺寸，我幫您建議。',
  '3': '折扣後實際支付滿 NT$899 即免運，宅配和超商取貨都適用。外島地區不在免運範圍內。有其他問題歡迎繼續詢問。',
  '4': '客服時間：週一至週五 09:00–12:00 / 13:00–17:00。非服務時間可留言，將於下個工作日回覆。',
  '5': '訂單查詢需人工協助，請提供手機號碼與訂單編號後四碼，客服將於工作時間回覆您。###NEED_HUMAN###',
  '6': '團購優惠說明即將上線，敬請期待！如有相關問題歡迎直接詢問。',
  '7': '好友推薦活動說明即將上線，敬請期待！如有相關問題歡迎直接詢問。',
  '8': '7天鑑賞期內未拆封可退。登入官網 > 會員中心 > 訂單查詢申請，系統提供 7-11 退貨便代號，3天內到IBON操作完成。已拆封貼身衣物因衛生考量無法退換，試穿後亦同。\n\n詳情：https://enamorshop.com/pages/return_policy',
  '9': '現貨商品 1~3 個工作天出貨，出貨後超商或宅配約 2~4 天送達。預購商品需等全部備齊才一起寄出。萊卡抗菌無縫系列預購約 14 天，其他預購款約 7 天。',
  '10': '__AI__'
};
