...
Q：請問免運費是多少？
A：只要結帳時扣除折扣後的實際金額達到 NT$999，宅配和超商取貨都可以免運喔！要特別注意的是，免運門檻是以折扣後的金額為準，外島或海外地區的話就不在範圍內了。有其他問題歡迎繼續問我 😊
...
const QUICK_REPLIES = {
  ...
  '3': '只要結帳時折扣後的實際金額滿 NT$999，宅配和超商取貨都可以免運喔！要注意的是免運是以折扣後的金額為準，外島地區的話不在範圍內。有其他問題歡迎繼續問我 😊',
